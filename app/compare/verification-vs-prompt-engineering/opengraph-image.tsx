...
export const alt = "Verification vs Prompt Engineering — Which Ensures AI Safety? | Delentia Labs"
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", padding: "48px 64px 44px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 900 }}>
            <h1 style={{ fontSize: 52, fontWeight: 700, color: "#f9fafb", margin: 0, lineHeight: 1.1, letterSpacing: "-0.025em" }}>
              Verification-First vs Prompt Engineering
            </h1>
            <p style={{ fontSize: 24, color: "#9ca3af", margin: 0, lineHeight: 1.5 }}>
              Why structured verification layers produce more reliable AI outputs than fine-tuned prompt chains.
            </p>
          </div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
