...
For the current public SDK checkpoint, see `docs/testing/TESTING_CANONICAL.md`. The deployment metrics below are architecture guidance for ASEAN rollout planning rather than a frozen public-SDK release baseline:
