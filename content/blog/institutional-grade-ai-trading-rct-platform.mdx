...
claimScope: "architecture-blueprint"
...
The public `rct-platform` SDK line provides the algorithmic core. A production trading deployment requires three additional components:
