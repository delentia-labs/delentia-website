...
- [DelentiaDB 8-Dimensional Memory Schema](/blog/rctdb-8-dimensional-memory-schema) — the storage layer that HexaCore models read and write to via Delta Engine
