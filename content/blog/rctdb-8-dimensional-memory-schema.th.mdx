---
title: "DelentiaDB v2.0: Universal Memory Schema 8 มิติสำหรับระบบ AI"
...
category: "research"
excerpt: "DelentiaDB คือสถาปัตยกรรมหน่วยความจำสากลของ RCT Ecosystem — schema 8 มิติที่ออกแบบสำหรับ AI memory ที่มีโครงสร้าง, การติดตาม provenance เต็มรูปแบบ และสิทธิการลบข้อมูลตาม PDPA บทความนี้อธิบาย schema, สาม storage zone และเหตุใด traditional vector database จึงไม่เพียงพอสำหรับ AI องค์กร"
...
| ความต้องการ | Vector Database | DelentiaDB |
|---|---|---|
...
1. DelentiaDB records ทั้งหมดที่มี `subject_uuid` ที่สอดคล้องถูก retrieve
