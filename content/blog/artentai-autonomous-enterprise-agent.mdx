...
claimScope: "enterprise-architecture"
...
For the current public SDK checkpoint, use the canonical proof in `docs/testing/TESTING_CANONICAL.md`. The enterprise agent metrics below should be read as architecture and enterprise-environment guidance, not as the public proof lane for the SDK:
...
| Language support | English-first | Regional adapter support with ASEAN-focused enterprise coverage |
