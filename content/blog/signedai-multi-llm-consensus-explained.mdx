...
tags: ["SignedAI", "Multi-LLM", "Consensus", "Hallucination Prevention", "Constitutional AI", "Delentia Labs"]
readTime: 9
references:
...
### With DelentiaDB
Every SignedAI consensus round is committed to DelentiaDB with:
...
- **Full audit trail:** Every consensus round committed to DelentiaDB with Ed25519 signatures
