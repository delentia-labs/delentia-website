---
title: "delentia-os v1.0.2a0: Apache 2.0 Public Alpha Now Available on GitHub"
...
excerpt: "delentia-os v1.0.2a0 is now publicly available on GitHub under Apache 2.0. The SDK ships 723 passing tests, 89% coverage, five reference microservices, and the full FDIA + JITNA reference implementation — no API keys required to get started."
tags: ["Open Source", "SDK", "Apache 2.0", "delentia-os", "GitHub", "FDIA", "JITNA", "Constitutional AI", "Public Alpha"]
readTime: 8
references:
  - "https://github.com/delentia-labs/delentia-os"
  - "https://delentia.com/products/delentia-platform"
  - "https://delentia.com/protocols/fdia-equation"
  - "https://delentia.com/open-protocol"
  - "https://choosealicense.com/licenses/apache-2.0/"
  - "https://delentia.com/benchmark-summary"
---
...
[delentia-os v1.0.2a0](https://github.com/delentia-labs/delentia-os) is a Public Alpha release of the RCT Ecosystem's core SDK — the layer that implements the [FDIA equation](/protocols/fdia-equation), JITNA Protocol RFC-001, SignedAI multi-LLM consensus, the Delta Engine, and five reference microservices. It ships under the Apache 2.0 license with 723 passing tests, 89% coverage, and a full offline demo that requires no API keys.
...
- **Commercial use is allowed.** You can use, modify, and distribute `delentia-os` in proprietary products without publishing your modifications.
...
The enterprise layer — 62 microservices, the HexaCore inference cluster, DelentiaDB, the MEE production pipeline — remains proprietary. The SDK is the public interface that connects to that layer.
...
- **GitHub Discussions** — async community Q&A, design discussions, and RFC feedback. Now live — join the conversation at [github.com/orgs/rctlabs/discussions](https://github.com/orgs/rctlabs/discussions).
...
- **PyPI alpha publish** — `pip install delentia-os==1.0.3a0` as a first-step PyPI presence, separate from the stable v1.0.0 target.
...
- [delentia-os on GitHub](https://github.com/delentia-labs/delentia-os) — source, docs, issues
