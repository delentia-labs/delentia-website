...
tags: ["JITNA", "Protocol", "RFC-001", "Agentic AI", "Constitutional AI", "Delentia Labs"]
readTime: 11
references:
...
### JITNA + DelentiaDB
Every completed JITNA transaction is committed to DelentiaDB — the 8-dimensional universal memory schema. This means:
...
- **Integration:** FDIA gating, SignedAI consensus, DelentiaDB memory, HexaCore routing
...
- 🤖 [Delentia Labs vs LLM APIs — how JITNA solves the vendor lock-in problem](/en/compare/delentia-labs-vs-llm-apis)
- 🧠 [Intent Operating System — the full 4-layer architecture JITNA fits into](/en/blog/intent-operating-system-explained)

---

*This article was written by Ittirit Saengow, founder and sole developer of Delentia Labs. JITNA is part of the RCT (Reverse Component Thinking) Ecosystem — a constitutional AI operating system built independently in Bangkok, Thailand.*
