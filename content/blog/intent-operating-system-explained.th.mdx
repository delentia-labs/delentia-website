...
| State management | Persistent AI memory ตลอด session | DelentiaDB 8-dimensional schema |
...
| Audit trail | Decision provenance สำหรับ compliance | DelentiaDB dimension 8: provenance |
...
- **Right to erasure:** เมื่อ data subject ขอ erasure `subject_uuid` จะถูก tombstone ใน DelentiaDB query ถัดมาที่จะดึง UUID นั้นได้รับข้อมูลเป็นศูนย์ — ไม่ใช่ placeholder ไม่ใช่ error ไม่มีอะไร การ erase สมบูรณ์
