...
ตัวเลขเหล่านี้ไม่ใช่ค่าเฉลี่ย — พวกมันคือผลจาก automated test suite ที่รันทุก commit และ benchmark ที่ accessible ต่อสาธารณะที่ [delentia.com/benchmark](/benchmark)
