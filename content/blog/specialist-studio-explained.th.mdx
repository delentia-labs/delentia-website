...
- **[Intent Farming](/th/blog/intent-farming-grow-ai-context)** — DelentiaDB persistence ของ Studio สร้าง domain-specific intent profiles เมื่อเวลาผ่านไป ลด cold-start costs ทุก session
