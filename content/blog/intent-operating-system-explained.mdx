...
Any references in this article to 62 microservices should be read as an enterprise-private snapshot or enterprise environment description, not as the public SDK proof lane.
