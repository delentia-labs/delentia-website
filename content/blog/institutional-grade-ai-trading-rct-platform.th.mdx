...
public `rct-platform` SDK line ให้ Algorithm Core โดย Production Trading Deployment ต้องการ 3 Component เพิ่มเติม:
