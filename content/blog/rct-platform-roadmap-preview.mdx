...
excerpt: "delentia-os v1.0.2a0 is live. Here is what was shipped, what is in progress, and what is coming in v1.0.3a0, v1.0.0 stable, v1.1.0 Observability, and v1.2.0 ASEAN Expansion — and what we are explicitly not building in the open-source tier."
tags: ["RCT Platform", "Platform Roadmap", "Open Source", "FDIA", "SignedAI", "JITNA", "ASEAN AI", "delentia-os"]
readTime: 9
references:
  - "https://github.com/delentia-labs/delentia-os"
  - "https://delentia-labs.github.io/delentia-os/"
  - "https://delentia.com/en/architecture"
---
...
If you want the raw roadmap document, it lives at [ROADMAP.md](https://github.com/delentia-labs/delentia-os/blob/main/ROADMAP.md) in the repository.
...
- `pip install delentia-os` works from PyPI without cloning or building locally
...
- JITNA Protocol RFC-002 — cross-platform agent identity standard. This addresses the problem that arises when multiple organizations deploy `delentia-os` instances and need their agents to communicate across organizational boundaries without sharing their underlying knowledge stores
...
|---|---|
| Full production microservice stack (62 services) | Enterprise tier — [delentia.com](https://delentia.com) |
| Genome Creator Profile API | Enterprise proprietary |
| Hosted inference engine | Hardware/cost constraints outside OSS scope |
| Hosted API / SaaS endpoint | Runs at delentia.com — enterprise licensing |
...
- **Enterprise timeline requests** — if your organization needs a specific feature by a specific date, contact [founder@delentia.com](mailto:founder@delentia.com). Enterprise commitments can accelerate specific items.
